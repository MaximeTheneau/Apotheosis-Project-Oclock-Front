  ...
  return (
    <>
      ...
      <div>
        ...
        <p>Le membre s’engage à tenir des propos respectueux des autres et de la loi&nbsp;
          et accepte que ces publications soient modérées ou refusées par l’Éditeur,
          sans obligation de justification. <br />
          En publiant sur le site, l’Utilisateur cède à la société éditrice&nbsp;
          le droit non exclusif et gratuit de représenter, reproduire, adapter, modifier,
      ...
      <div>
        <p>Tout dysfonctionnement du serveur ou du réseau ne peut engager
          ...
          Le site O’Miam s'engage à mettre en œuvre tous les moyens nécessaires&nbsp;
      ...
      <div>
        <p>Les contenus du site O’Miam (logos, textes, éléments graphiques, vidéos, etc.)
          ...
          L’Utilisateur devra obtenir l’autorisation de l’éditeur du site&nbsp;
          avant toute reproduction, copie ou publication de ces différents contenus.<br />
          Ces derniers peuvent être utilisés par les utilisateurs à des fins privées
          ; out usage commercial est interdit.<br />
          L’Utilisateur est entièrement responsable de tout contenu qu’il met en ligne
          et il s’engage à ne pas porter atteinte à un tiers.<br />
          L’Éditeur du site se réserve le droit de modérer ou de supprimer librement&nbsp;
      ...
      <div>
        <p>L’Utilisateur doit obligatoirement fournir des informations personnelles&nbsp;
          ...
          par le site O’Miam pour la communication d’informations diverses&nbsp;
          et la gestion du compte.<br />
          O’Miam garantit le respect de la vie privée de l’utilisateur
      ...
      <div>
        <p>Les domaines vers lesquels mènent les liens hypertextes présents sur le site
          ...
          Il est possible pour un tiers de créer un lien vers une page du site O’Miam
