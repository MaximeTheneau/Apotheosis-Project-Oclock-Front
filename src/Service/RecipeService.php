...
class RecipeService
{
    ...
    {
        $urlPicture = $request->getSchemeAndHttpHost().'/public/omiam/sources/images/recipe/';
        ...
        if (!$file) {
            ...
            $file->move($this->projectDir . $this->sourcesDir . $this->recipesImageDir, 'recipe_'.$recipe->getId().'.webp');
